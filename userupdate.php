            ...
            if(isset($_POST['Save']))
            {
             ...
             // print_r($id);
              ...
              if (mysqli_query($conn,$query)) {
                  ...
                  echo '<script>alert("Successfully Updated!!");location.href="userDetailsList.php"</script>';
                }
                else{
                  echo "<script>alert('Unsuccessful!!');location.href='userDetailsList.php';</script>";
...
<div class="features_area section_gap_change">
        ...
        <div class="containerChange">
            ...
            <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="POST" action="userupdate.php"enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input" >
                    ...
                    <input class="input100" type="text" name="fname" value="<?php if(!empty($row['fname'])) echo $row['fname']; ?>" placeholder="Enter father name">
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Mother Name:</span>
                    <input class="input100" type="text" name="mname" value="<?php if(!empty($row['mname'])) echo $row['mname']; ?>" placeholder="Enter mother name">
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" >
                ...
                <div class="wrap-input100 validate-input" >
                    ...
                    <input class="input100" type="text" name="gnumber" value="<?php if(!empty($row['gnumber'])) echo $row['gnumber']; ?>" placeholder="Enter contact number">
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Room No:</span>
                    <input class="input100" type="text" name="roomno" value="<?php if(!empty($row['roomno'])) echo $row['roomno']; ?>" placeholder="Enter room no" required>
                    <span class="focus-input100"></span>
                </div>
