...
<div class="features_area section_gap_change">
        ...
        <div class="containerChange">
            <div class="wrap-contact100">
                ...
                <div class="wrap-input100 validate-input">
                    ...
                    <textarea class="input100" type="text"  name="rcontent"     placeholder="Enter Complain">
                    </textarea>
                </div>
   ...
   //print_r($_POST);
                ...
                if(mysqli_query($conn,$query)){
                    echo '<script>alert("Successfully Complained!!");location.href="reportList.php"</script>';
